...
| Understand disconnected agentic operation and Gemma 4 product-e2e | `what/agentic-disconnected-operation.md` |
| Understand per-run cancellation and global hard-stop behavior | `what/agentic-run-termination.md` |
